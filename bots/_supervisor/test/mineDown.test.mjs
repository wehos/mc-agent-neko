...
check('fluid near -> unsafe', stairSafety({ feet: 'stone', head: 'stone', floor: 'stone', fluidNear: true }).safe === false);
...
check('plain stone -> safe', stairSafety({ feet: 'stone', head: 'stone', floor: 'stone', fluidNear: false }).safe === true);
